...
class TrainArgParser(BaseArgParser):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--val_csv',
        ...
        self.parser.add_argument('--metric_name',
                                 ...
                                 choices=('chexpert-log_loss',
                                          ...
                                          'shenzhen-AUROC',
                                          'ranzcr-competition-AUROC',
                                          'jsrt-competition-AUROC',
                                          'indiana-competition-AUROC',
                                          'montgomery-AUROC',
                                          'shenzhen-tb-competition-AUROC',
                                          'pediatric-pneumonia-competition-AUROC',
                                          'siim-competition-AUROC',
                                          'pulmonary-edema-AUROC',
        ...
        self.parser.add_argument('--loss_fn',
                                 ...
                                 choices=('cross_entropy','multi_cross_entropy'),
        ...
        self.parser.add_argument('--normalization',
                                 ...
                                 default='imagenet',
                                 choices=('imagenet', 'chexpert_norm', 'ranzcr_norm', 'jsrt_norm', 'indiana_norm', 'montgomery_norm','siim_acr_pneumothorax_norm', 'shenzhen_tb_norm','pediatric_pneumonia_norm','pulmonary_edema_norm'))
