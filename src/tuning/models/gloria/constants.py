...
RANZCR_TRAIN_CSV = RANZCR_DATA_DIR / "train.csv"
RANZCR_VALID_CSV = RANZCR_DATA_DIR / "valid.csv"
RANZCR_TEST_CSV = RANZCR_DATA_DIR / "test.csv"
...
RANZCR_PATH_COL = "StudyInstanceUID"
...
# CheXpert constants
CHEXPERT_DATA_DIR = Path("/deep/group/data/moco/chexpert-proper-test-random-v2/moving_logs")
