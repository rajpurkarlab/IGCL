# -----------------------------------------------------------
#  Code borrowed from the CheXZero paper. 
#  Loads a model with the CLIP architecture.
# -----------------------------------------------------------
...
def preprocess_text(texts, model):
    ...
    for i, tokens in enumerate(all_tokens):
        if len(tokens) > model.context_length:
            # use first `model.context_length` tokens
            # todo: choose random sequence of tokens that is context_length long
